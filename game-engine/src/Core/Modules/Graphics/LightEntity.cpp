...
const std::string LightEntity::SHADER_NUMLIGHTS_NAME = "num_lights";
const std::string LightEntity::SHADER_LIGHT_NAME = "lights[";
const std::string LightEntity::SHADER_POSITION_NAME = "].position";
...
const std::string LightEntity::SHADER_CONSTANT_NAME = "].constant";
const std::string LightEntity::SHADER_LINEAR_NAME = "].linear";
const std::string LightEntity::SHADER_QUADRATIC_NAME = "].quadratic";
...
void LightEntity::loadToShader(Shader *shader, const unsigned int &index)
{
...
void LightEntity::loadNumLightsToShader(Shader *shader, const unsigned int &count)
{
    // Quadratic attenuation
...
void LightEntity::fillUniformNames(std::vector<std::string> &uniformNames)
{
    uniformNames.push_back(SHADER_NUMLIGHTS_NAME);
    
    for(unsigned int i = 0; i < Graphics::MAX_LIGHTS; i++)
    {
