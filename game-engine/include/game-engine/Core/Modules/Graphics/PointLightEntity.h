...
public:
    PointLightEntity(const std::string &name, const glm::vec3 &position, const glm::vec3 &ambient, const glm::vec3 &diffuse, const glm::vec3 &specular, const Attenuation &attenuation, const bool &on = DEFAULT_ON)
    : LightEntity(LightEntity::POINT, name, position, ambient, diffuse, specular, on), attenuation(attenuation)
    {}
